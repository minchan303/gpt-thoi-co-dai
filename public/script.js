...
document.querySelectorAll('.sidebar .task').forEach(el=>el.addEventListener('click',()=>{
  document.querySelectorAll('.sidebar .task').forEach(t=>t.classList.remove('active'));
  el.classList.add('active');
  const tk = el.getAttribute('data-task');
  document.getElementById('taskSelect').value = tk;
}));
